...
export default {
  ...
  data() {
    return {
      ...
      description: 'The number of unique addresses that appeared for the first time in an Etherem transaction.',
  ...
  methods: {
    ...
    async getData() {
      ...
      const values = newAddresses.slice(newAddresses.length - days); // works since glassnode currently has 24h interval on free plan
